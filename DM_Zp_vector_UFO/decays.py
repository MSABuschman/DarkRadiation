# This file was automatically created by FeynRules 2.0.34
# Mathematica version: 9.0 for Microsoft Windows (64-bit) (February 13, 2013)
# Date: Thu 16 Apr 2015 16:06:34
...
Decay_Zp = Decay(name = 'Decay_Zp',
                 particle = P.Zp,
                 partial_widths = {(P.b,P.b__tilde__):'((24*MB**2*Zpq**2 + 12*MZp**2*Zpq**2)*cmath.sqrt(-4*MB**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.c,P.c__tilde__):'(MZp**4*Zpq**2)/(4.*cmath.pi*abs(MZp)**3)',
                                   (P.d,P.d__tilde__):'(MZp**4*Zpq**2)/(4.*cmath.pi*abs(MZp)**3)',
                                   (P.DM,P.DM__tilde__):'((8*Mdm**2*Zpchi**2 + 4*MZp**2*Zpchi**2)*cmath.sqrt(-4*Mdm**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.s,P.s__tilde__):'(MZp**4*Zpq**2)/(4.*cmath.pi*abs(MZp)**3)',
                                   (P.t,P.t__tilde__):'((24*MT**2*Zpq**2 + 12*MZp**2*Zpq**2)*cmath.sqrt(-4*MT**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.u,P.u__tilde__):'(MZp**4*Zpq**2)/(4.*cmath.pi*abs(MZp)**3)'})
